              ...
              {mockReports.map((r) => (
                <tr key={r.id} className="hover:bg-muted/20 transition-colors">
                  <td className="px-4 py-3.5">
                    ...
                    <p className="text-xs text-muted-foreground sm:hidden mt-0.5">{r.clientName}</p>
                  </td>
                  <td className="px-4 py-3.5 text-muted-foreground hidden sm:table-cell">{r.clientName}</td>
                  <td className="px-4 py-3.5 hidden md:table-cell"><StatusBadge status={r.type} /></td>
                  <td className="px-4 py-3.5 text-muted-foreground hidden lg:table-cell">{r.date}</td>
