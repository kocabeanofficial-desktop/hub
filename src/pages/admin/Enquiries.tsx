  ...
  return (
    <DashboardLayout>
      <div className="space-y-4">
        <div>
          <h1 className="text-xl sm:text-2xl font-heading font-bold text-foreground">Enquiries</h1>
              ...
              <tbody className="divide-y divide-border">
                {filtered.map((enq) => (
                  <tr key={enq.id} className="hover:bg-muted/20 transition-colors cursor-pointer">
                    ...
                    <td className="px-4 py-3 text-muted-foreground hidden sm:table-cell">{enq.service}</td>
                    <td className="px-4 py-3 text-muted-foreground hidden md:table-cell">{enq.source}</td>
                    <td className="px-4 py-3 text-muted-foreground hidden lg:table-cell">{enq.createdAt}</td>
